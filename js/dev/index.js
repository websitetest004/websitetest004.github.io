...
function initSliders() {
  if (document.querySelector(".result__slider")) {
    new Swiper(".result__slider", {
      ...
      // Кнопки "вліво/вправо"
      navigation: {
        prevEl: ".result__slider-prev",
        nextEl: ".result__slider-next"
      },
      // Брейкпоінти
      breakpoints: {
        320: {
  ...
  if (document.querySelector(".reviews__slider-1")) {
    new Swiper(".reviews__slider-1", {
      modules: [Autoplay],
      observer: false,
      observeParents: false,
      slidesPerView: 4,
  ...
  if (document.querySelector(".reviews__slider-2")) {
    new Swiper(".reviews__slider-2", {
      modules: [Autoplay],
      observer: false,
      observeParents: false,
      // slidesPerView: 4,
  ...
  if (document.querySelector(".reviews__slider-3")) {
    new Swiper(".reviews__slider-3", {
      modules: [Autoplay],
      observer: false,
      observeParents: false,
      slidesPerView: 4,
...
function menuBurger() {
  ...
  const navShort = document.getElementById("nav-short");
...
function titleImage() {
  const imageHTML = `
  <span data-fls-dynamic=".hero__container, 767, 0" data-fls-watcher="" data-fls-watcher-once="" class="hero__image">
    <img alt="Іконка іграшки"  src="./assets/img/hero/01.webp" >
  </span>
`;
  const title = document.querySelector(".hero__title");
  title.innerHTML = title.innerHTML.replace("унікальну", '<span class="unique" data-fls-watcher="" data-fls-watcher-once="">унікальну</span>');
...
function uploadForm() {
  ...
  const form = document.querySelector(".create__form.upload-form");
  ...
  input.addEventListener("change", () => {
    ...
    previewWrapper.classList.add("step-2-wrapper");
    const newLabel = document.createElement("label");
    newLabel.classList.add("upload-other", "upload-area");
    newLabel.innerHTML = `
		<div class="upload-icon upload-icon-2">
		<img alt="Фото завантаження"  src="./assets/img/icons/create/01.webp" >
		</div>
		<p class="upload-text upload-text-2">Upload other photo</p>
		<input type="file" id="photo-upload-2" accept="image/*">
	`;
    const imgWrapper = document.createElement("div");
    imgWrapper.classList.add("create__image-2");
